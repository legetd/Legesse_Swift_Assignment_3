     ...
     class CruiseShip: Ship {
         ...
         func addPassenger() {
             if currentPassengerCount < maxCapacity {
                 ...
                 print("Cannot add more passengers. Max capacity (\(maxCapacity)) ")
             }
         }
     ...
     class CargoShip: Ship {
         ...
         func addCargo() {
             if currentCargoCount < maxCargoCapacity {
                 ...
                 print("Cannot add more cargo. Max capacity (\(maxCargoCapacity)) ")
             }
         }
     ...
     class PirateShip: Ship {
         ...
         func addTreasure() {
             if currentTreasureCount < maxTreasureCapacity {
                 ...
                 print("Cannot add more treasure. Max capacity (\(maxTreasureCapacity)) ")
             }
         }
